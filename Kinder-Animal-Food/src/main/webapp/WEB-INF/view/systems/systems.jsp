...
<body>
	<table width=100% height="100" border="0" bgcolor="#4a4a48">
		<tr>
			<td align="center">
				<div id="HWHP">
					<a href="../systems/" style="font-size: 40px">Kinder Animal
						Food</a>
				</div>
			</td>
			<td>&nbsp;</td>
	...
	<table width=100% height=1000 bgcolor=white>
		<tr height>
			<td height width="250">
				<table width="250" height=100% border="0" bgcolor="#4a4a48">
					<tr>
					...
					<tr>
						<td align="left" height="40">
							<div id="Arial">
								<a href="CheckReport" style="font-size: 15px">&nbsp;&nbsp;&nbsp;Check
									Report</a>
							</div>
						</td>
					</tr>
					<tr>
						<td align="left" height="40">
							<div id="Arial">
								<a href="Insert" style="font-size: 15px">&nbsp;&nbsp;&nbsp;Insert
									Data</a>
							</div>
						</td>
					</tr>
			...
			<td><iframe name="content" frameborder="0" width="100%"
					height="800" scrolling="no"></iframe></td>
		</tr>
	</table>
</body>
</html>
