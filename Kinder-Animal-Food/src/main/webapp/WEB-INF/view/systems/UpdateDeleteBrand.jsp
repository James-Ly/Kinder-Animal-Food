					...
					<table width=100% height=100% bgcolor=white>
						<tr>
							<td bgcolor=#f5f5f5 height="50"><font face="Arial"
								color="Black" size="4px">&nbsp;&nbsp;Brand</font></td>
						</tr>
						<tr>
							<td height="50">
								...
								<table border="1" height=100% width=100% cellspacing="0">
									...
									<c:forEach items="${requestScope.brands}" var="b">
										<tr height="40">
											<td>
												<div id="Black">
													<a href="BrandDetails/${b.getBrand_name()}/${b.getBrand_category()}">${b.getBrand_name()}</a>
												</div>
											</td>

											<td><c:forEach items="${b.getAccreditations()}" var="bA">
													<p>${bA.getAccreditation_name()}--${bA.getRating()}</p>
												</c:forEach></td>
											<td>${b.getBrand_category()}</td>
											<td><input type="checkbox" name="delete"
												value="${b.getBrand_name()}_${b.getBrand_category()}">
											</td>
										</tr>
									</c:forEach>
