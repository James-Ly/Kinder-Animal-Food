...
<!--Update/ Delete Brand -->
			<td valign="top">
				<font face="Arial" color="Black" size="8px">Update/ Delete Brand</font>
				<form method="get" action="UpdateDeleteBrandProcess">
				<table width=100% height = 100% bgcolor = white>
					<tr>
						<td bgcolor = #f5f5f5 height="50">
							<font face="Arial" color="Black" size="4px">&nbsp;&nbsp;Brand</font>
						</td>
					</tr>
					<tr>
						<td height="50">
					...
					<tr>
						<td>
							...
							<tr height="30">
								<td width="400">
									<strong><font face="Arial" color="Black" size="4px">&nbsp;&nbsp;Brand Name</font></strong>
								</td>
								<td width="500">
									<strong><font face="Arial" color="Black" size="4px">&nbsp;&nbsp;Accreditation</font></strong>
								</td>
								<td width="200">
									<strong><font face="Arial" color="Black" size="4px">&nbsp;&nbsp;Category</font></strong>
								</td>
								<td>
							...
							<c:forEach items="${requestScope.brands}" var="b">
								...
								<td>${b.getAccreditation_name()}</td>
								<td>${b.getBrand_category()}</td>
								<td><input type="checkbox" name="delete" value="${b.getBrand_id()}"></td>
								</tr>
							</c:forEach>
